...
class Model_afiliador_comercio extends CI_Model {

    public function id_negocio_registrado   ($usuario_id)
    {
        $instruccion = "SELECT usuario_id from usuarios where afiliador =  $usuario_id ORDER BY usuario_id DESC LIMIT 1";
