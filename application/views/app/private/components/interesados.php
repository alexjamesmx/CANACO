...
<?php
   $i=0; foreach ($interesados as $row) { 
     $contacto='contacto'.$i;
     $mensaje='mensaje'.$i; 
    // var_dump($interesados);
     //var_dump($row->miid);
                        ...
                        <div>                                                 
                            <div class="card m-3" align='center'>
                                <a class="" href="#" >
                                    ...
                                    <img src="<?=base_url().'static/uploads/perfil/'.$row->negocio_logo ?>" alt="<?php  echo($row->negocio_nombre); ?>"
                                    class="img-thumbnail responsive border-0" align='center' style="max-height: 100px !important;" />
                                    <?php }else{ ?>
                                    <img src="<?=base_url().'static/uploads/perfil/logo_default.png'?>" alt=<?php  echo($row->negocio_nombre); ?>
                                    class="img-thumbnail responsive border-0" align='center' style="max-height: 100px !important;" />
                                    <? } ?>
                                </a>
                                <div>
...
<?php   }else{ ?>
    <div class="container" align='center'>
            ...
            <img src="<?=base_url('static/admin/img/no_encontrado.png')?>"
                                        class="img-fluid"
                                        style="height:500px; widht: 400px  ">
            </div>
        </div>
    <?php } ?>