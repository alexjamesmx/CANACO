    ...
    <div style="margin-top: 50px;">
        <table cellpadding="0" cellspacing="0" style="font-family: Poppins, sans-serif; font-size: 15px; font-weight: 400; border: none; margin: 0 auto; border-radius: 6px; overflow: hidden; background-color: #fff; box-shadow: 0 0 3px rgba(60, 72, 88, 0.15);">
            ...
            <tbody>
                ...
                <tr>
                    <td style="padding: 24px 24px 0; text-align: center">
                        <img src="https://enlacecanaco.org/static/images/Online report_Two Color.png" height="400" alt="">
                    </td>
                </tr>
                <tr>
                    <td style="padding: 24px 24px 0;">
                ...
                <tr>                    
                    <td style="padding: 24px 24px 0;">
                        <table cellpadding="3" cellspacing="0" style="border: none;">
                            <tbody>                                  
                                <tr>
                                    <td style="min-width: 130px; padding-bottom: 8px;">Especificaciones: </td>
                                    <td style="color: #3a3c39; min-width: 130px; padding-bottom: 8px;">32 tinacos de urgencia para almacenar agua potable</td>
                                </tr>                                
                            </tbody>
                        </table>
                    </td>
