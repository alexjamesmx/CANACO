            ...
            <tbody>
                <tr>
                    <td style="padding: 24px 24px 0;">
                        <h1 style="text-align: center;"><?=$titulo_perso?></h1>
                    </td>
                </tr>
                <tr>
                    <td style="padding: 24px 24px 0; text-align: center">
                        <img src="<?=$notification->img_header?>" style="max-height: 400px !important;">
                    </td>
                </tr>
                <tr>
                    <td style="padding: 24px 24px 0;">
