                            ...
                            <a class="w-100 w-sm-100">
                                <div style="" class="list-item-heading mb-0 truncate">
                                    ...
                                    <div style="" class="mb-4">
                                        ...
                                        <?php } else {
                                            echo '<i class="fas fa-times"></i>  Este Comercio no Factura';
                                        } ?>
                                    </div>
                                                    ...
                                                    <?php if (isset($medallas)) { ?>
                                                        ...
                                                        <?php foreach ($medallas as $meds) { ?>
                                                            <button class="btn" style="display: inline-block">
                                                                <img src="<?= base_url('static/recompensas/medallas/' . $meds->medalla_img) ?>" class="img-fluid d-block mx-auto " style="max-height: 25px;" disabled>
                                                            </button>
                                                    <?php }
                                                    } else {
                                                    ...
                                                    <?php if (isset($insignias)) { ?>
                                                        ...
                                                        <?php foreach ($insignias as $insig) { ?>
                                                            ...
                                                            <button class="btn  p-1" style="display: flex">
                                                                <img src="<?= base_url('static/recompensas/insignias/' . $insig->insignia_img) ?>" class="img-fluid d-block mx-auto " style="max-height: 30px; " disabled>
                                                            </button>
                                                    <?php }
                                                    } else {
...
<?php   } else { ?>
    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" align='center'>
        <div class="card m-3" align='center'>
            ...
            <img src="<?= base_url('static/images/losentimos.png') ?>" class="img-fluid d-block mx-auto" style="max-height: 930px !important;">
        </div>
    </div>
