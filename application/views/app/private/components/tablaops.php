<table id="controls-data-tables-pagination" class="data-table nowrap table table-bordered table-striped" data-order="[[ 0, &quot;desc&quot; ]]">
    ...
    ?>
        <tbody>
            <?php
            $eestatus_actual = 'eestatus_actual' . $i;
            $controls = 'controls' . $i;
            $modal = 'mc' . $i;
            $modalcancelar = 'mcc' . $i;
            $modalr = 'mcr' . $i;
            ...
            <tr>
                ...
                <td data-title="Eestatus actual">
                    <?php if (
                        $estatus == '17'
                    ) { ?>
                        <div id='<?= $eestatus_actual ?>'>
                        ...
                        <?php if (
                            ...
                            <div class="btn-group">
                                <!-- <?php if (!isset($cotizacion_opng)) { ?>
                                    ...
                                    <?php } ?> -->
                                <button class="btn btn-dark default btn-default" data-dismiss="modal" onclick='aplicar(<?= $usuario_id ?>,<?= $opneg_id ?>,<?= $controls ?>,<?= $eestatus_actual ?>,<?= $modal ?>,<?= $modalcancelar ?>,<?= $req_id ?>,"<?= $cotizacion_opng ?>",<?= $coti ?>)'>
                                    <i class="fas fa-check"></i>
                                    <br>
                                    Aplicar
                                </button>
                        ...
                        <div class="modal-body">
                            <div class="card m-12" id="div_modal">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick='rechazar(<?= $usuario_id ?>,<?= $opneg_id ?>,<?= $controls ?>,<?= $eestatus_actual ?>,<?= $rechaza ?>)'>Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card m-12" id="div_modal">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
                                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick='cancelar(<?= $usuario_id ?>,<?= $opneg_id ?>,<?= $controls ?>,<?= $eestatus_actual ?>, <?= $cancela ?>)'>Aceptar</button>
                                </div>
                            </div>
                        </div>
                    </div>
