...
<div id="modal-addkeywords" class="modal fade" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="" class="row" id="form-add-keywords" name="form-add-keywords">
                    <div class="col-sm-12 form-group">
                        ...
                        <select class="form-control" id="prodserv" name="prodserv">
                            <option label="&nbsp;"> &nbsp;</option>
                    ...
                    <div class="col-sm-12 form-group">
                        ...
                        <select class="form-control select2-single" data-width="100%" id="tactividad" name="tactividad">
                            <option label="&nbsp;"> &nbsp;</option>
                    ...
                    <div class="col-sm-12">
                        <button class="btn text-primary" onclick='ask_for_help()'>
                    ...
                    <div class="col-sm-12 form-group mt-3">
                        ...
                        <input data-role="tagsinput" type="text" class="form-control" id="keywords" name="keywords">
                    </div>
                    <div class="col-sm-12 form-group mt-3">
