    ...
    <?php foreach($account_data_n as $account){?>  
        ...
        <div class="form-row mt-4 mb-3">
            <div class="col-md-12">
                ...
                <h5 class="conuter-head text-muted"> valor para tu perfil 20%</h5> 
                <hr>      
                <hr>
            </div>
        </div>
                    ...
                    <div class="form-group col-sm-6"> 
                        <label for="Comprobante">
                            <sup><i class="fas fa-asterisk text-danger" 
                                ...
                                <input type="file" name="docs2" id="2" 
                            ...
                            <div class="form-group col-sm-6">
                                <label for="Constancia">
                                    <sup><i class="fas fa-asterisk text-danger" 
                                        ...
                                        <input type="file" name="docs4" id="4" 
                                        class="form-control required btn btn-primary"  >
                                    </div>
                                <?php }?>
                                <?php if($catalog==null || $catalog =="(NULL)" ){ ?>
                                    <div class="form-group col-sm-6">
                                        <label for="Cv">
                                            <sup></sup> 
                                                Opcional,  este documento no tiene un valor en su porcentaje del perfil
                                                <input type="file" name="docs5" id="5" 
