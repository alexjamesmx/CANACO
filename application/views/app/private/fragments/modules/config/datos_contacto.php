...
<div class="form-row">
    <div class="form-group col-sm-4">
        <label for="nombre">
            ...
            maxlength="40" value="<?=$account_data->nombre?>">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <div class="form-group col-sm-12">
                                <h6> ¿La Información de contacto es la misma que el departamento de compras?  </h6>   
                     ...
                     <div class="form-group col-sm-12">
                        <h6> ¿La Información de contacto es la misma que el departamento de ventas?  </h6>   
                        <div class="custom-switch custom-switch-primary mb-2">
