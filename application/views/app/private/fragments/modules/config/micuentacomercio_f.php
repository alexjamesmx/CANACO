        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <h1 class="text-left m-0 p-0">
                    ...
                    <?php endif;
                    extract((array)($account_data_n[0]));
                    echo ucwords($this->session->nombre . ' ' .  $this->session->apellido1 . ' ' . $this->session->apellido2); ?>
                </h1>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div id="accordion">
                    ...
                    <!-- SECCION CURRICULUM DEL COMERCIO -->
                    <div class="border">
                        <button id="title-cv-comercio" class="btn btn-link collapsed click-title btn-colapse-valor" data-toggle="collapse" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                            <h2>
                    ...
                    <!-- SECCION DOCUMENTACION DEL NEGOCIO -->
                    <section id="afildiv">
                        <div class="border">
                            <button id="title-docs-comercio" class="btn btn-link collapsed click-title btn-colapse-valor" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                <h2>
                    ...
                    <!-- SECCION DATOS CONTACTO -->
                    <div class="border">
                        <button id="title-data-contacto" class="btn btn-link collapsed click-title btn-colapse-valor" data-toggle="collapse" data-target="#collapseMil" aria-expanded="false" aria-controls="collapseMil">
