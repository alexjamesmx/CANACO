...
<?php if ($this->session->userdata('rol_id') == 2) : ?>
    ...
    <div class="row">
        <div class="col-12">
            <div id="custom_marquee_parent" style="height:50px">
    ...
    <!-- Modal NO MATCHES -->
    <div class="modal fade" id="modal_nomatch" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" style="max-width:700px !important; min-width:fit-content">
            <div class="modal-content" style="border-radius: 24px;">
                <div class="modal-body">

                    <!-- GRID CONTAINER -->
                    <div style="grid-template-columns: repeat(3, 1fr); grid-template-rows: 10% repeat(2, 1fr) repeat(2, 10%);display: grid;gap: 12px;padding-left: 12px;">

                        <!-- HEADER -->
                        <div id="nomatch_header" style="grid-column: 1/4;grid-row:1;margin-bottom: 2rem;opacity:0">
                            <div class="d-flex">
                                <h2 class="modal-title m-0 p-0" id="modal_nomatch_title"></h2>
                        ...
                        <!-- IMAGEN PERFIL -->
                        <div id="nomatch_profile" style="justify-self:center;grid-row: 2/4;grid-column: 1;position: relative;opacity:0">
                            <span id="profile_eye" style="opacity:0" class='modal_perfil_logo_eye'></span>
                            <img id="modal_perfil_logo" src="" alt="Foto de negocio" class='modal_perfil_logo' onclick="ver_perfil_publico(this)" onmouseout="profileHoverHide()" onmouseover="profileHover()" loading="lazy">
                        </div>
                        <!-- CAMPOS OCULTOS -->
                        ...
                        <!-- DETALLES -->
                        <div id="nomatch_detalles" style="grid-area: 2 / 2 / span 4 / span 3;padding: 1rem;border-top-left-radius: 24px;border-bottom-left-radius: 24px;border-top-right-radius: 24px;border-bottom-right-radius: 24px;opacity:0">
                        ...
                        <!-- SUBTITULO DE FOTO -->
                        <div id="nomatch_verperfil" style="justify-content: center; grid-row: 4/5;grid-column: 1/2;  display: grid;opacity:0">
                            <span class="modal_perfil_div_text_small myaccount-img align-self-center p-2" style="text-align: center;font-weight: bold;" id="ver_perfil" onclick="ver_perfil_publico(this)">
                                <i class='fas fa-user'></i>
                                Ver perfil
                            </span>
                        </div>

                        <div id="nomatch_contacto">
                            <p class="modal-info-section m-0 p-0 mr-5">Si su negocio puede proveerlo, por favor contacte y satisfaga la demanda.</p>
                            <button type="button" class="btn btn-info whatsapp" onclick="handleWhatsapp(this)">Contactar
