<div class="row">
    <div class="col-12 mb-2 mb-4">
                ...
                <div class="card-body">
                    ...
                    <form class="login-form" id="form_registro_tractora_afiliador" method="post" 
                    data-type="json" action="<?= base_url(
                        'app/Afiliador_comercio/registrotractora'
                    ) ?>" >
                        <div class="row">
                        <div class="col-md-12">
                                <div class="mb-3">
                ...
                <div id="accordion" style="display:none;">
                    <div class="border">
                        ...
                        <div id="collapseThree" class="collapse show" data-parent="#accordion" style="">
                            <div class="p-4">
                            <form id="form-update-comercio" action="<?= base_url(
                                'app/AfiliadorComercioUsuario/uptractora'
                            ) ?>"
                    ...
                    <div class="border">
                        ...
                        <div id="collapseTwo" class="collapse show" data-parent="#accordion" style="">
                            <div class="p-4">
                                    ...
                                    action="<?= base_url(
                                        'app/AfiliadorComercioUsuario/data_personal_tractora'
                                    ) ?>"
                                    class="validate-ptp" method="post" data-type="json"> 
                                                <div class="form-row mt-4 mb-3">
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="email" name="email_auth_c" id="email_auth_c" 
                                            class="form-control required" required="" maxlength="70" 
                                            value="pruebatest@gmail.com">
                                            <small class="form-text text-muted">
                                                &nbsp;
                                            </small>
                                        </div>
