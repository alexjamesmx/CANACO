            ...
            <div id="accordion" style="display:none;">
                ...
                <div class="border">
                    ...
                    <div id="collapseThree" class="collapse show" data-parent="#accordion" style="">
                        <div class="p-4">
                            <form id="form-update-comercio" action="<?=base_url('app/AfiliadorComercioUsuario/upnegocio')?>"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4"  id='patronbi'>
                                        ...
                                        <input type="text" name="patronal" id="patronal" class="form-control required valid" required="" maxlength="150" style="text-transform:uppercase" value="">
                ...
                <div class="border">
                    ...
                    <div id="collapseTwo" class="collapse show" data-parent="#accordion" style="">
                        <div class="p-4">
                            ...
                            action="<?=base_url('app/AfiliadorComercioUsuario/doupdate')?>"
                            class="validate-ptp" method="post" data-type="json"> 
                            <div class="form-row mt-4 mb-3">
                                <div class="col-md-12">
