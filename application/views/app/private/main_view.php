...
<head>
    ...
    <link id='css_dynamic_marquee' rel='stylesheet' href="<?= base_url() ?>static/admin/css/dynamic_marquee.css" />
</head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 d-none d-sm-block" style="align-self:center">
                            <ul class="breadcrumb pt-0 pr-0 float-right">
                                ...
                                <li class="breadcrumb-item mb-0">
                                    <a href="https://www.canacoqueretaro.org/membresias" target="_blank" class="btn-link">Membresías</a>
                                </li>
                                <li class="breadcrumb-item mb-0">
