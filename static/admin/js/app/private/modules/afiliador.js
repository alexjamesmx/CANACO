          ...
          success: ( response ) => {
            ...
            if ( repuesta.toString() === 'warning' ) {
              ...
              if ( rfc === '' || rfc == null || rfc === undefined ) {
                document.getElementById( 'personabi' ).setAttribute( 'style', 'display: none' )
                document.getElementById( 'patronbi' ).setAttribute( 'style', 'display: none' )
                document.getElementById( 'rfcbi' ).setAttribute( 'style', 'display: none' )
                document.getElementById( 'rfc2bi' ).setAttribute( 'style', 'display: none' )
                $( '#RFC' ).val( null )
                $( '#CRFC' ).val( null )
              } else {
                $( '#RFC' ).val( String( rfc ) )
