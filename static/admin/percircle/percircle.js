!(function (t) {
    ...
    t.fn.percircle = function (e) {
        ...
        return this.each(function () {
            ...
            s.hasClass('percircle') || s.addClass('percircle'),
                'undefined' != typeof s.attr('data-animate') &&
                    (e.animate = 'true' == s.attr('data-animate')),
                e.animate && s.addClass('animate'),
                'undefined' != typeof s.attr('data-progressBarColor')
                    ? ((e.progressBarColor = s.attr('data-progressBarColor')),
                      (n = "style='border-color: " + e.progressBarColor + "'"),
                      d(t(this), e.progressBarColor))
                    : 'undefined' != typeof e.progressBarColor &&
                      ((n = "style='border-color: " + e.progressBarColor + "'"),
                      d(t(this), e.progressBarColor));
            ...
            if (i) {
                ...
                c
                    ? (s.hasClass('perclock') || s.addClass('perclock'),
    ...
    var r = function (e, r, a) {
            function s() {
                if (
                    ((c -= 1),
                    c > 30 && e.addClass('gt50'),
                    c < 30 && e.removeClass('gt50'),
                    i(),
                    c <= 0)
                )
                    return n(), void e.html('<span>' + l + '</span>');
            }
            function o() {
                m = setInterval(s, 1e3);
            }
